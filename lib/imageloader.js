...
var spinner_1 = require("../../@tspower_spinner/lib/spinner");
stili.default;
var ImageLoader = /** @class */ (function () {
    function ImageLoader(Root, DisplayUploadButton, Url, InputName, Style, ButtonStyle, ImageStyle) {
        ...
        this.Init = function () {
            ...
            _this.fileLoader.changed$.subscribe(function (val) {
                ...
                _this.btn_load.classList.remove("disabled");
                _this.btn_erase.classList.remove("disabled");
            });
            ...
            _this.uploaded$.subscribe(function (promise) {
                promise.then(function () {
                    _this.spinner.style.display = 'none';
                    _this.btn_erase.classList.add("disabled");
                    _this.btn_load.classList.add("disabled");
                }).catch(function () {
                    _this.spinner.style.display = 'none';
                    _this.btn_load.classList.add("disabled");
                });
        ...
        this.fileLoader = new fileloader_1.FileLoader(this.tag, false, null, null, "display:block;width:72px;height:24px;");
